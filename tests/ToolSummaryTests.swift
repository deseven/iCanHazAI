...
extension AllAppTests {
    ...
    struct ToolSummaryTests {
        ...
        func readFile() {
            #expect(
                ToolSummary.callEntries(name: "read_file", arguments: json(["path": "src/main.swift"]))
                    == [ToolSummary.Entry(key: nil, value: "src/main.swift")])
            #expect(
                ToolSummary.callEntries(
                    name: "read_file", arguments: json(["path": "a.txt", "offset": 10, "limit": 50]))
                    == [
        ...
        func shell() {
            #expect(
                ToolSummary.callEntries(
                    name: "shell", arguments: json(["command": "ls -la", "cwd": "/tmp", "timeout": 30]))
                    == [
            ...
            #expect(
                ToolSummary.callEntries(name: "shell", arguments: json(["command": "cd /tmp\nls -la"]))
        ...
        func configurator() {
            #expect(
                ToolSummary.callEntries(name: "delete_role", arguments: json(["name": "Old"]))
                    == [ToolSummary.Entry(key: nil, value: "Old")])
            #expect(
                ToolSummary.callEntries(name: "check_connection", arguments: json(["id": "openai/gpt-4o"]))
        ...
        func unknownRequiredFirst() {
            ...
            #expect(
                ToolSummary.callEntries(name: "mcp__srv__tool", arguments: args, requiredArgs: ["zebra", "apple"]).map(
                    \.key)
        ...
        func unknownMissingRequired() {
            ...
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: args, requiredArgs: ["alpha", "missing"]).map(
                    \.key)
                    == ["alpha", "beta"])
        }
        ...
        func unknownKeyOrder() {
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: #"{"zebra":1,"apple":2,"mango":3}"#).map(\.key)
                    == ["zebra", "apple", "mango"])
        }
        ...
        func unknownValues() {
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: json(["query": "cats"]))
                    == [ToolSummary.Entry(key: "query", value: "cats")])
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: json(["ids": [1, 2, 3]]))
                    == [ToolSummary.Entry(key: "ids", value: "1 2 3")])
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: json(["flag": true]))
        ...
        func malformedArgs() {
            #expect(
                ToolSummary.callEntries(name: "some_tool", arguments: "{broken json")
        ...
        func callLine() {
            #expect(
                ToolSummary.callLine(name: "read_file", arguments: json(["path": "a.txt", "offset": 10]))
                    == "a.txt · offset: 10")
        ...
        func doneAndError() {
            let done = ToolSummary.resultStatus(
                name: "some_tool",
                result: ToolResult(callID: "c", content: "\n\n  first line  \nsecond", isError: false))
            #expect(done == ToolSummary.Status(kind: .done, label: "done", description: "first line"))

            let error = ToolSummary.resultStatus(
                name: "some_tool",
                result: ToolResult(callID: "c", content: "file not found: a.txt\ndetails", isError: true))
        ...
        func streaming() {
            #expect(
                ToolSummary.resultStatus(
                    name: "some_tool",
                    result: ToolResult(callID: "c", content: "partial", isError: false, isStreaming: true)) == nil)
        }
        ...
        func readFileResult() {
            ...
            let image = ToolSummary.resultStatus(
                name: "read_file",
                result: ToolResult(
        ...
        func counting() {
            #expect(
                ToolSummary.resultStatus(
                    name: "ls",
                    result: ToolResult(callID: "c", content: "src/\nPackage.swift\nREADME.md", isError: false))?
                    .description == "Listed 3 items.")
            #expect(
                ToolSummary.resultStatus(name: "ls", result: ToolResult(callID: "c", content: "", isError: false))?
                    .description == "Listed 0 items.")
            #expect(
                ToolSummary.resultStatus(
                    name: "find_file",
                    result: ToolResult(
                        callID: "c", content: "a.txt\nb.txt\n... (truncated at 200 results)", isError: false))?
                    .description == "Found 2 items.")
            #expect(
                ToolSummary.resultStatus(
                    name: "find_text",
                    result: ToolResult(callID: "c", content: "src/a.swift:10:match one", isError: false))?.description
                    == "Found 1 item.")
        }
        ...
        func configuratorResults() {
            #expect(
                ToolSummary.resultStatus(
                    name: "list_roles",
                    result: ToolResult(callID: "c", content: "- Assistant\n- Developer", isError: false))?.description
                    == "Listed 2 items.")
            #expect(
                ToolSummary.resultStatus(
                    name: "list_connections", result: ToolResult(callID: "c", content: "(none)", isError: false))?
                    .description == "Listed 0 items.")
            #expect(
                ToolSummary.resultStatus(
                    name: "check_mcp_stdio",
                    result: ToolResult(callID: "c", content: "- search — web search\n- fetch", isError: false))?
                    .description == "Found 2 tools.")
            #expect(
                ToolSummary.resultStatus(
                    name: "read_role",
                    result: ToolResult(callID: "c", content: "[role]\nname = \"Dev\"\n", isError: false))?.description
                    == "Read 2 lines.")
            #expect(
                ToolSummary.resultStatus(
                    name: "read_log",
                    result: ToolResult(callID: "c", content: "(application log is empty)", isError: false))?.description
                    == "(application log is empty)")
        }

        @Test("denied strips the boilerplate prefix; cancelled has no description")
        func deniedAndCancelled() {
            let denied = ToolSummary.resultStatus(
                name: "some_tool",
                result: ToolResult(
            ...
            let generic = ToolSummary.resultStatus(
                name: "some_tool",
                result: ToolResult(
            ...
            let cancelled = ToolSummary.resultStatus(
                name: "some_tool",
                result: ToolResult(
        ...
        func codableRoundTrip() throws {
            ...
            let result = ToolResult(
                callID: "c1", content: "1|x", isError: false,
